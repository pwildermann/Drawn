...
struct TimerActivityAttributes: ActivityAttributes {
    ...
    public struct ContentState: Codable, Hashable {
        ...
        /// Thumbnail for this activity update; also kept on attributes for the first frame.
        var doodleImageData: Data? = nil
        /// `true` when the countdown hit zero: alarm UI (Figma 134:1119) until the user dismisses.
